...
if not vim.loop.fs_stat(lazypath) then
    vim.fn.system({ "git", "clone", "--filter=blob:none", "https://github.com/folke/lazy.nvim", "-b stable", lazypath })
end
...
require("lazy").setup({
	...
	opts = {
		...
		function(server_name)
		    require("lspconfig")[server_name].setup({server={capabilities = require('cmp_nvim_lsp').default_capabilities()}})
		end,
	    },
	},
    },
    ...
    {'xvzc/chezmoi.nvim',lazy=false,dependencies = { 'nvim-lua/plenary.nvim' },
	config = function()
